...
关联图谱：`/Users/myke/Documents/MERJIC/概念库/memory/concept_relations.db`（SQLite）
脚本：`/Users/myke/Documents/MERJIC/概念库/scripts/sync_db.py`
...
新增/修改概念页后，运行 `python3 /Users/myke/Documents/MERJIC/概念库/scripts/sync_db.py --incremental` 即可同时刷新索引和 DB。
...
运行 `python3 /Users/myke/Documents/MERJIC/概念库/scripts/sync_db.py --incremental`（同时完成 SQLite 同步 + JSON 索引刷新）。
